...
tf.flags.DEFINE_string("positive_data_file", "/path/to/good_leads", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "/path/to/bad_leads", "Data source for the negative data.")
tf.flags.DEFINE_string("model_base_dir", None, "Data source for the negative data.")
...
# Training parameters
tf.flags.DEFINE_integer("checkpoint_version", 1, "checkpoint version")
...
if len(sys.argv) < 4:
    print('Usage: lead_prediction_saved.py [--positive_data_file=a] [--negative_data_file=b] [--model_base_dir=c] [--checkpoint_version=d]')
    sys.exit(-1)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        out_dir = os.path.abspath(os.path.join(FLAGS.model_base_dir, "checkpoints", str(FLAGS.checkpoint_version)))
        print("Writing to {}\n".format(out_dir))
